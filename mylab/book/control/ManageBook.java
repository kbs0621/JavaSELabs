...
public class ManageBook {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n=== 가격 변경 ===");
        System.out.println("대상 도서: " + target.getTitle());
        System.out.println(target.getTitle() + "변경 전 가격: " + beforePrice + "원");
        System.out.println(target.getTitle() + "변경 후 가격: " + afterPrice + "원");
        System.out.println("할인 금액: " + diff + "원");
